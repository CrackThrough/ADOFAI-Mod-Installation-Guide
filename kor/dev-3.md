...
모드를 완성했다면 사람들에게 알릴 차례입니다. 모드를 출시해 알리는 가장 효과적인 방법은 [모딩 커뮤니티 디스코드](https://discord.gg/AGFXhCfyE5) (9월 18일 이후부터는 [adofai.gg 디스코드](https://discord.gg/3QrTehqp55))에 모드를 출시하는 것입니다. 
