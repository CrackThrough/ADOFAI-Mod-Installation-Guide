...
3. 모드를 업데이트 했다면, `#모드-업데이트` 채널에 변경 사항과 함께 [아래 가이드라인](#모드-출시-가이드라인)을 따라 새로운 버전의 모드를 출시합니다.
...
### 모드의 버전
모드 버전은 [유의적 버전](https://semver.org/lang/ko/)을 지켜 표시하고, 내용이 너무 많아 헷갈리다면 아래 사진을 참고해 버전을 설정하셔도 됩니다.
